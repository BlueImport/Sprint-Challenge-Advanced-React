...
- [x] Why would you use class component over function components (removing hooks from the question)?
        ...
        Class components can hold state if your aren't using useState. They also have the ability to access the react life cycle methods.

- [x] Name three lifecycle methods and their purposes.

        componentDidMount - runs after a component successfully mounts, but not when it is created in memory.

        componentWillUnmount - suited really only for cleaning up, this is the last little wisp of the component.

        Constructor - this puts the component in the memory.

- [x] What is the purpose of a custom hook?

        It reads and writes to state, which is awesome, but also, gives you just a little more because you can use it whenever.

- [x] Why is it important to test our apps?

        Testing is going to happen one way or another. Doing the testing in development allows us to do the testing instead of the client.
